...
public class StockMarketNewsManager : MonoBehaviour
{
    ...
    private const string GeneralStockMarketNewsScriptPath = "./Assets/Scripts/Python_API_Script/script_general_stock_market_news.py";
    private const string RetrieveWebpageScriptPath = "./Assets/Scripts/Python_API_Script/script_url_screenshot_retrieval.py";
